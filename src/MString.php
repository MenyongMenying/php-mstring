...
final class MString
{
    ...
    /**
     * Mengecek apakah string memiliki format json yang valid.
     * @param  string  $data String yang akan dicek.
     * @return bool       Hasil pengecekan.
     */
    public function isValidJsonFormat(string $data) :bool
    {
        json_decode($data);
     ...
     * @param  string $data String json yang akan di decode.
     * @return array|object Hasil decode.
     */
    public function jsonDecode(string $data, bool $object = false) :array|object
    {
